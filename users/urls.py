...
urlpatterns = [
    ...
    path('favoritos/productos/<int:pk>/', views.toggle_product_favorite, name='toggle_product_favorite'),
    path('favoritos/tiendas/<int:pk>/', views.toggle_store_favorite, name='toggle_store_favorite'),
